      ...
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-20">
        ...
        >
          ...
          >
            ...
            <div className="relative w-full aspect-square rounded-[24px] overflow-hidden shadow-2xl">
              <Image
                src="/ashutosh-avatar.jpeg" /* Make sure this matches your exact file name! */
                alt="Ashutosh Khadria - AI Avatar"
                fill
                priority
        ...
        >
          ...
          <p className="text-white/60 text-base leading-relaxed mb-4">
            I&apos;m Ashutosh Khadria. I built Artha AI because I watched
            brilliant CAs, lawyers, and architects drown in repetitive work —
            client follow-ups, document drafts, appointment scheduling — while
            their competition grew. AI is not the future. It&apos;s the unfair
            advantage available right now.
          </p>
          <p className="text-white/60 text-base leading-relaxed mb-8">
            We&apos;ve helped 50+ professionals reclaim their time and 3× their
            lead pipelines. Start with our free AI Diagnostic Test. In 3
            minutes, you&apos;ll get a personalized score showing exactly where
            AI can save you the most time — and money.
          </p>
          <div className="mb-8">
